...
export class SendChatValidation implements PipeTransform {
  transform(input: SendChatDto | SendChatWithFileDto | SendChatWithImageDto) {
  ...
  private getDtoClass<
    T extends SendChatDto | SendChatWithFileDto | SendChatWithImageDto,
  >(type: ChatType): ClassConstructor<T> | null {
    switch (type) {
